...
import { View, Image, type ImageSourcePropType, type HostComponent } from 'react-native';

import invariant from 'invariant';
import RCTWebView2, { Commands, type NativeProps } from './RCTWebView2NativeComponent.windows';
  ...
  (
    ...
    const resolvedSource =
      typeof sourceResolved === 'object'
        ? (sourceResolved as Partial<WebViewSourceUri & WebViewSourceHtml>)
        : undefined;
    const newSource = resolvedSource
      ? {
          uri: resolvedSource.uri,
          method: resolvedSource.method,
    ...
    const sourceHeaders = resolvedSource?.headers
      ? JSON.stringify(resolvedSource.headers)
      : undefined;
